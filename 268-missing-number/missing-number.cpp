...
public:
    int missingNumber(vector<int>& nums) {
        ...
        // XOR sign ^.5 ^ 5 = 0 number with it self gives zero 5 ^ 0 =5 number with zero gives number it self.
        ...
        XOR1 = XOR1 ^ n; //  1^2^3    and   xor2 is 3^1
        return XOR1 ^ XOR2;  
        // -- -- -All common numbers cancel out, Remaining value = missing number
    };
};